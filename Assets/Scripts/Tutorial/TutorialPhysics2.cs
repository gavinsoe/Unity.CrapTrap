...
public class TutorialPhysics2 : MonoBehaviour {
	...
	void OnGUI ()
    {
        ...
        GUILayout.FlexibleSpace();
        GUILayout.Label("similarly, blocks will", activeSkin.customStyles[0]);
        GUILayout.Label("fall", activeSkin.customStyles[1]);
        GUILayout.Label("when", activeSkin.customStyles[0]);
        GUILayout.FlexibleSpace();
        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();
        GUILayout.FlexibleSpace();
        GUILayout.Label("no corners are touching", activeSkin.customStyles[0]);
        GUILayout.FlexibleSpace();
        GUILayout.EndHorizontal();
